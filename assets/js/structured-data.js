...
const cafeTranslations = {
  en: {
    ...
    faq9Question: "Do you offer wine by the bottle?",
    faq9Answer: "Yes. Besides house white, amber, and red, we offer 60+ wines by the bottle — Georgian and from around the world. Your server will be happy to share details and help you select a wine to your liking.",
  ...
  ru: {
    ...
    faq9Question: "Вы предлагаете вино в бутылках?",
    faq9Answer: "Да. Помимо вина по бокалам, мы предлагаем более 60 вин — грузинских и со всего мира. Ваш официант будет рад рассказать о нашем ассортименте подробнее и помочь подобрать вино по вашему вкусу.",
  ...
  de: {
    ...
    faq9Question: "Bieten Sie Wein in der Flasche an?",
    faq9Answer: "Ja. Neben Hauswein weiß, amber und rot bieten wir über 60 Weine in der Flasche — georgisch und aus aller Welt. Ihr Kellner gibt Ihnen gerne Auskunft und hilft Ihnen bei der Auswahl eines Weins nach Ihrem Geschmack.",
    ...
    faq9Question: "Şişede şarap sunuyor musunuz?",
    faq9Answer: "Evet. Bardağa sunulan şarapların yanı sıra 60'tan fazla şişe şarap sunuyoruz — Gürcü ve dünyanın dört bir yanından. Garsonunuz detayları paylaşmaktan ve beğeninize uygun bir şarap seçmenize yardımcı olmaktan mutluluk duyacaktır.",
    ...
    faq9Question: "Proposez-vous du vin à la bouteille?",
    faq9Answer: "Oui. En plus du vin de la maison blanc, ambré et rouge, nous proposons plus de 60 vins à la bouteille — géorgiens et du monde entier. Votre serveur se fera un plaisir de vous donner des détails et de vous aider à choisir un vin à votre goût.",
    ...
    faq9Question: "¿Ofrecen vino por botella?",
    faq9Answer: "Sí. Además del vino de la casa blanco, ámbar y tinto, ofrecemos más de 60 vinos por botella — georgianos y de todo el mundo. Su camarero estará encantado de darle más información y ayudarle a elegir un vino de su gusto.",
    ...
    faq9Question: "Offrite vino in bottiglia?",
    faq9Answer: "Sì. Oltre al vino della casa bianco, ambrato e rosso, offriamo oltre 60 vini in bottiglia — georgiani e da tutto il mondo. Il vostro cameriere sarà lieto di fornirvi dettagli e aiutarvi a scegliere un vino di vostro gradimento.",
    ...
    faq9Question: "ბოთლში ღვინო გაქვთ?",
    faq9Answer: "დიახ. ბურგერით ღვინის გარდა, ბოთლში 60-ზე მეტი ღვინი გვაქვს — ქართული და მსოფლიოს სხვადასხვა კუთხიდან. თქვენი მიმტანი სიამოვნებით გაგიზიარებთ დეტალებს და დაგეხმარებათ ღვინის არჩევაში თქვენი გემოვნების მიხედვით.",
    ...
    faq9Question: "你们提供瓶装葡萄酒吗？",
    faq9Answer: "是的。除杯装店酒（白、琥珀、红）外，我们提供60余款瓶装葡萄酒——格鲁吉亚及世界各地。服务员很乐意为您介绍并帮您挑选适合您口味的葡萄酒。",
    ...
    faq9Question: "هل تقدمون نبيذًا بالزجاجة؟",
    faq9Answer: "نعم. بالإضافة إلى النبيذ بالكأس، نقدم أكثر من 60 نبيذًا بالزجاجة — جورجي ومن جميع أنحاء العالم. سيكون النادل سعيدًا بمشاركة التفاصيل ومساعدتك في اختيار نبيذ يناسب ذوقك.",
